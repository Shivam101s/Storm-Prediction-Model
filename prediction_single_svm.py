...
# Step 4: Train a Classification Model with SVM
# SVM model initialization
model = SVC(kernel='rbf', random_state=42, probability=True)  # Using RBF kernel (default for non-linear classification)
